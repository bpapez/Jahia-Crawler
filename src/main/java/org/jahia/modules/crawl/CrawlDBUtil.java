...
public class CrawlDBUtil {

    private static final Log LOG = LogFactory.getLog(CrawlDBUtil.class);
    ...
    public static Configuration createConfiguration() {
        ...
        conf.addResource("crawl-sites.xml");
        return conf;
    }
    ...
    public static void generateSeedList(FileSystem fs, Path urlPath,
        ...
        Path file = new Path(urlPath, "jahia-urls.txt");
        fs.mkdirs(urlPath);
        out = fs.create(file);
